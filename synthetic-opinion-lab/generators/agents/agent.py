...
class OpinionAgent:
    ...
    def _trait_to_opinion(self, topic: str) -> float:
        ...
        # Simple mapping of topics to trait combinations
        # In practice, this would be more sophisticated
        topic_lower = topic.lower()

        if "government" in topic_lower or "policy" in topic_lower:
            # Government topics: ideology + trust_in_government
